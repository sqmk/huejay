...
function require_accessor(accessor) {
  switch(accessor) {
    case 'Actions': 
      return require('./Accessor/Actions');
    case 'Bridge':
      return require('./Accessor/Bridge');
    case 'Capabilities':
      return require('./Accessor/Capabilities');
    case 'Groups':
      return require('./Accessor/Groups');
    case 'Lights':
      return require('./Accessor/Lights');
    case 'Portal':
      return require('./Accessor/Portal');
    case 'ResourceLinks':
      return require('./Accessor/ResourceLinks');
    case 'Rules':
      return require('./Accessor/Rules');
    case 'Scenes':
      return require('./Accessor/Scenes');
    case 'Schedules':
      return require('./Accessor/Schedules');
    case 'Sensors':
      return require('./Accessor/Sensors');
    case 'SoftwareUpdate':
      return require('./Accessor/SoftwareUpdate');
    case 'TimePatterns':
      return require('./Accessor/TimePatterns');
    case 'TimeZones':
      return require('./Accessor/TimeZones');
    case 'Users':
      return require('./Accessor/Users');
  }
}
...
class Client {
  ...
  loadAccessor(accessor) {
    if (!this.accessors[accessor]) {
      let Accessor = require_accessor(accessor);
